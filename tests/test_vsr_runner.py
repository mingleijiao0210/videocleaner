...
def test_small_dark_residual_uses_local_repair_without_full_crop_pass():
    ...
    repaired[22:27, 45:50] = 0
    result = _repair_small_dark_residuals(source, repaired, mask)
    assert int(result[24, 47, 0]) > 180
